...
public class SistemaEncuentrosFacade {
    ...
    public Usuario registrarUsuario(String usuario, String email, String contrasena, Deporte deporte, NivelJuego nivel, Posicion ubicacion) {
    ...
    public void crearEncuentro(String id, Deporte deporte, int cantidadJugadoresNecesarios, int duracionMinutos,
        ...
        gestorEncuentros.crear(id, deporte, cantidadJugadoresNecesarios, duracionMinutos, ubicacion, horario, organizador, nivelMinimo, nivelMaximo, permitirCualquierNivel);;
    }
